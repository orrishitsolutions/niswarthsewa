	...
	<div class="container-fluid ">
		<div class="row r1 ">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-foot ">
				...
				<div class="r1 row ">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rad-us text-center"><a href="# "><i
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-foot ">
				...
				<div class="row">
					<div class="col-lg-5 col-md-3 col-sm-6 col-xs-6 logo-foot "><img class="img-responsive"
																					 src="<?= base_url('assets/frontend/img/logo-foot1.png'); ?>"
																					 alt="logo-foot1.png "></div>
					<div class="col-lg-5 col-md-3 col-sm-6 col-xs-6 logo-foot logo-foot1 "><img class="img-responsive"
																								src="<?= base_url('assets/frontend/img/logo-foot2.png'); ?>"
																								alt="logo-foot2.png ">
					</div>
				</div>
			</div>
					...
					<div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
						...
						<div class="d-flex align-items-center pt-4 px-7">
							<button type="button" class="close ml-auto target-of-invoker-has-unfolds active"
									aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="true"
									data-unfold-event="click" data-unfold-hide-on-scroll="false"
									data-unfold-target="#sidebarContent" data-unfold-type="css-animation"
									data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight"
									data-unfold-duration="500"><i class="ec ec-close-remove"></i></button>
						</div>
						<div class="js-scrollbar u-sidebar__body mCustomScrollbar _mCS_3 mCS-autoHide"
							 style="position: relative; overflow: visible;">
													...
													<div class="tab-content" id="Jpills-tabContent">
														<div class="tab-pane fade active show"
																...
																<div class="js-form-message js-focus-state">
																	...
																	<div class="input-group">
																		<div class="input-group-prepend"><span
																					...
																					id="signinEmailLabel"><span
																						class="fas fa-user"></span></span>
																		</div>
																		<input type="email" class="form-control"
																			   name="login_email" id="signinEmail"
															...
															<div class="form-group">
																<div class="js-form-message js-focus-state">
																	...
																	<div class="input-group">
																		<div class="input-group-prepend"><span
																					class="input-group-text"
																					id="signinPasswordLabel"><span
																						class="fas fa-lock"></span></span>
																		</div>
																		<input type="password" class="form-control"
																			   name="login_password" id="signinPassword"
															...
															<div class="d-flex justify-content-end mb-4"><a
																		...
																		data-animation-in="slideInUp">Forgot
																	Password?</a></div>
															<div class="mb-2">
																<button type="submit"
							...
							<div id="mCSB_3_scrollbar_vertical"
								...
								<div class="mCSB_draggerContainer">
									<div id="mCSB_3_dragger_vertical" class="mCSB_dragger"
										 style="position: absolute; min-height: 50px; top: 0px; display: block; height: 476px; max-height: 465.875px;">
...
<a href="https://api.whatsapp.com/send?phone=+919999999999&amp;text=Welcome to Nishivarth Sewa" target="_blank"
   style="position:fixed;left:0px;bottom:0px;"><img src="<?= base_url('assets/frontend/img/fa-whatsapp.png'); ?>"
...
<a class="js-go-to u-go-to" href="#" data-position='{"bottom": 15, "right": 15 }' data-type="fixed"
   data-offset-top="400" data-compensation="#header" data-show-effect="slideInUp" data-hide-effect="slideOutDown"><span
			class="fas fa-arrow-up u-go-to__inner"></span></a>
...
<script src="<?= base_url('assets/frontend/js/megamenu.js'); ?>"></script>
...
<script src="<?= base_url('assets/frontend/js/core.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/countdown.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/header.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/unfold.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/focus-state.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/malihu-scrollbar.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/validation.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/fancybox.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/onscroll-animation.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/slick-carousel.js'); ?>"></script>
<script src="<?= base_url('assets/frontend/js/show-animation.js'); ?>"></script>
