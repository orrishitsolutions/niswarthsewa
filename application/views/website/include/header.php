						...
						<div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
							<ul class="navbar-nav u-header__navbar-nav">
								...
								<li class="nav-item hs-has-mega-menu u-header__nav-item men234us2"
									...
									<a id="homeMegaMenu"
									   class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale"
									   href="javascript:;" aria-haspopup="true" aria-expanded="false">Help in
										emergencies&nbsp; <i class="fa fa-angle-down"></i> </a>
									<div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="homeMegaMenu">
										<div class="row u-header__mega-menu-wrapper">
											<div class="col-md-6" style="    padding: 0px;">
												<ul class="u-header__sub-menu-nav-group">
													<li><a href="preparing.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/ideass.png" alt=""> &nbsp; Preparing
															for emergencies</a></li>
													<li><a href="how.html" class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/psychological-help.png" alt="">
															&nbsp; How can I help?</a></li>
												</ul>
											</div>
											<div class="col-md-6">
												<ul class="u-header__sub-menu-nav-group mb-3">
													<li><a href="coping.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/economy.png" alt=""> &nbsp; Coping
															after a crisis</a></li>
													<li><a href="resources.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/resources.png" alt=""> &nbsp;
															Resources to help you</a></li>
												</ul>
											</div>
										</div>
									</div>
								...
								<li class="nav-item hs-has-mega-menu u-header__nav-item  men234us3"
									...
									<a id="homeMegaMenu"
									   class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale"
									   href="javascript:;" aria-haspopup="true" aria-expanded="false"> Community
										...
										<div class="row u-header__mega-menu-wrapper">
											<div class="col-md-6">
												<ul class="u-header__sub-menu-nav-group">
													<li><a href="aged.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/care.png" alt=""> &nbsp; Aged care
															services for older people
														</a>
													</li>
													<li><a href="ndis.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/customer.png" alt=""> &nbsp; NDIS
															services
														</a>
													</li>
													<li><a href="mental.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/mental-health.png" alt=""> &nbsp;
															Mental health help
														</a>
													</li>
													<li><a href="homelessness.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/shelter.png" alt=""> &nbsp;
															Homelessness</a></li>
												</ul>
											</div>
											<div class="col-md-6" style="padding:0px;">
												<ul class="u-header__sub-menu-nav-group mb-3">
													<li><a href="aboriginal.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/torres-del-paine.png" alt=""> &nbsp;
															For Aboriginal and Torres Strait Islander peoples
														</a>
													</li>
													<li><a href="children.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/family.png" alt=""> &nbsp; Children
															and families
														</a>
													</li>
													<li><a href="people.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/legal-system.png" alt=""> &nbsp;
															People in the justice system
														</a>
													</li>
													<li><a href="young.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/skater.png" alt=""> &nbsp; Young
															Parents Program (NSW)
														</a>
													</li>
												</ul>
								...
								<li class="nav-item hs-has-mega-menu u-header__nav-item men234us4"
									...
									<a id="homeMegaMenu"
									   class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale"
									   href="javascript:;" aria-haspopup="true" aria-expanded="false">Contribute
										Material &nbsp; <i class="fa fa-angle-down"></i> </a>
									<div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="homeMegaMenu">
										<div class="row u-header__mega-menu-wrapper">
											<div class="col-md-12">
												<ul class="u-header__sub-menu-nav-group">
													<li><a href="dropping.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/water-drop.png" alt=""> &nbsp;
															Dropping Centers</a></li>
													<li><a href="collection.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/self-collect.png" alt=""> &nbsp;
															Collection Camps</a></li>
												</ul>
											</div>
										</div>
									</div>
								...
								<li class="nav-item hs-has-mega-menu u-header__nav-item  men234us5"
									...
									<a id="homeMegaMenu"
									   class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale"
									   href="javascript:;" aria-haspopup="true" aria-expanded="false">Get Involved
											...
											<div class="col-md-6">
												<ul class="u-header__sub-menu-nav-group">
													<li><a href="volunteer.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/volunteering.png" alt=""> &nbsp;
															Volunteer</a></li>
													<li><a href="membership.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/membership.png" alt=""> &nbsp;
															Membership</a></li>
													<li><a href="partner.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/partner.png" alt=""> &nbsp; Partner
															with us</a></li>
													<li><a href="corporate.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/business-partnership.png" alt="">
															&nbsp; Corporate Partnerships</a></li>
												</ul>
											</div>
											<div class="col-md-6">
												<ul class="u-header__sub-menu-nav-group mb-3">
													<li><a href="individual.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/individual.png" alt=""> &nbsp;
															Individual Support</a></li>
													<li><a href="institutional.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/bank.png" alt=""> &nbsp;
															Institutional Alliances</a></li>
													<li><a href="contribute.html"
														   class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/contribution.png" alt=""> &nbsp;
															Contribute Material</a></li>
												</ul>
											</div>
											<div class="col-md-12">
												<ul class="u-header__sub-menu-nav-group mb-3">
													<li><a href="#1" class="nav-link u-header__sub-menu-nav-link"><b
																	style="    font-size: 16px;">Learning Help</b></a>
													</li>
													<li id="ulanesd23"><a href="first.html"
																		  class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/first-aid-bag.png" alt=""> &nbsp;
															First Aid Courses</a></li>
													<li id="ulanesd23"><a href="schools.html"
																		  class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/presentation.png" alt=""> &nbsp; For
															schools</a></li>
													<li id="ulanesd23"><a href="community.html"
																		  class="nav-link u-header__sub-menu-nav-link"><img
																	src="assets/img/chat-group.png" alt=""> &nbsp;
															Community Conversations</a></li>
												</ul>
											</div>
										</div>
									</div>
