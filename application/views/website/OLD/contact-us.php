         ...
         <div class="row cont-extra-pad">
            ...
            <div class="col-md-4 align-self-center">
               <div class="con_infos_box wow fadeIn" data-wow-delay=".60s">
                  ...
                  <div class="cont_inf_text align-self-center">
                     <p><a href='#'>Info@lcemporio.com</a></p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-l0">
               <div class="row space-creator">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-l">
                     <div class="parent">
                        ...
                        <div class="padding-right">
                           ...
                           <div class="address">
                              <ul class="add-ul">
                                 <li>
                                    <p class="text-left">Info@lcemporio.com</p>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-r">
                     <div class="parent2">
                        <div>
                        </div>
                        <div class="form-p">
                           <form id="form">
                              <h3 class="txt2">SEND US AN EMAIL</h3>
                              <p class="text-left">Drop us a line by using the below form</p>
