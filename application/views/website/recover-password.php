				...
				<div class="col-md-5 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0">
					<div class="colampoxe">
						<div class="d-flex justify-content-between align-items-center border-bottom border-color-1 flex-lg-nowrap flex-wrap mb-4">
							<h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Recover Password</h3>
						</div>
						<?= !empty($login['error']) ? $login['error'] : ""; ?>
						<?= !empty($login['success']) ? $login['success'] : ""; ?>
						<p class="text-gray-901 mb-4">Don’t worry, we all forget. We’ll email you instructions on how to reset your password.</p>
						<form class="js-validate" novalidate="novalidate" method="post" action="<?= base_url("login/recover-password"); ?>" >
							...
							<div class="mb-1">
								<div class="mb-3"><button name="login" value="submit" type="submit" class="btn btn-primary-dark-w px-5">Send Email</button></div>
							</div>
						</form>
					</div>
				</div>
