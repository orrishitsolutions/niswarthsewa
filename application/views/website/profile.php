				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-12">
						...
						<div class="d-flex justify-content-between align-items-center border-bottom border-color-1 flex-lg-nowrap flex-wrap mb-4">
							<h3 class="section-title section-title__full mb-0 pb-2 font-size-22">Hello <?= $controller->profile['first_name'].' '.$controller->profile['middle_name'].' '.$controller->profile['last_name']; ?></h3><span><a style="color: #0a1122;" href="<?= base_url("profile/edit"); ?>" >Edit</a></span>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="hotel-form">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-12" style="text-align:left;">
									<div class="list">
										<h3 class="c-12d5dhi"><span class="list-heading">A smarter way to The Ngo around</span></h3>
										<p>
											5% additional discount on all Wizard member hotels and 10% off on Wizard Base.  Unlimited usage during the membership validity period. Experience true infinity Enjoy Wizard-exclusive, exciting deals at The Ngo.
											5% additional discount on all Wizard member hotels and 10% off on Wizard Base.  Unlimited usage during the membership validity period. Experience true infinity Enjoy Wizard-exclusive, exciting deals at The Ngo.
										</p>
									</div>
								</div>
			...
			<div class="container min-container">
				<div class="divaridkldf">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12">
							<h3>
								Donated History <span style="color: #0a1122; font-size: 12px;" >(<a style="color: #0a1122; font-size: 12px; text-decoration: underline;" href="<?= base_url("profile/donate"); ?>" >Click to Donate</a>)</span>
							</h3>
						</div>
					</div>
					<?php
